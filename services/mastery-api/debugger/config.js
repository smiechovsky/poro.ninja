...
// 0 = Database connection success, table existence/creation, service startup, service loop status
// 1 = Level 0 + start/end markers and overall aggregated result for each service loop
// 2 = Level 1 + detailed API calls, data processing steps, individual account processing
//
